...
$('.stream').css('opacity', '1');
  ...
  //console.log('error');
        ...
        /*    $.getJSON('https://api.twitch.tv/helix/users?login=' + value + '?client_id=x7fhewv9s5ohjlcp7ke8lfeoppsa5d&callback=?').then(function(status) {
                ...
                return $.getJSON('https://api.twitch.tv/helix/users?login=' + value);
